...
public class PrimaryWeapon : RangedWeapon
{
    ...
    {
        base.Awake();
        posibleAmmoTypes.Add(AmmoTypeEnums.RifleAmmo.Energy_RifleAmmo.ToString(),new RangedWeapon.AmmunitionType(this.damage,ProjectilePool.POOL_OBJECT_TYPE.ElectricProjectile,this.fireRate,0.45f,this.damage*3));
