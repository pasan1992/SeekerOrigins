...
public class PrimaryWeapon : RangedWeapon
{
    ...
    {
        base.Awake();
        posibleAmmoTypes.Add(AmmoTypeEnums.RifleAmmo.Energy_RifleAmmo.ToString(),new RangedWeapon.AmmunitionType(this.damage/4,ProjectilePool.POOL_OBJECT_TYPE.ElectricProjectile,this.fireRate,0.005f,this.damage*2,"Energy_RifleAmmo"));
