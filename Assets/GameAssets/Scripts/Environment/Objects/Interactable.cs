...
public class Interactable : MonoBehaviour
{
    ...
    public class InteractableProperties
    {
        ...
        public enum InteractableType {FastInteraction,PickupInteraction,TimedInteraction,ContinousInteraction,DialogInteraction,FixedContinousInteraction,ThrowBack,NullInteraction}
   
        public enum InteractionAction { LookAround = 1,Sit = 2,UseObject =3,Drinking = 4,Deativated=5,Crouching=6,Tracking=7,Idle=8,Making=9, Walking_Jump=10,Prayer1=11,Anger=12,Prayer2=13,Typing=14, Leaning=15, KneelingInspecting=16, SillyDancing = 17, SittingAngry =18, SittingClap =19, SittingDazed = 20, Defeted = 21, Sleeping = 22,Pickup=23,Biting=24, NotSpecified = -99}
